<!-- REFERENCES: https://www.websapex.com/blog/tutorial/php/simple-html-contact-form-to-send-email-in-php/ -->
...
<?php
    if(isset($_POST['submit']))
    {
        ...
        $to = "kishanchaudhary253@gmail.com"; // You can change here your Email
